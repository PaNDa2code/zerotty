...
pub fn init(
    ...
    try vkd.createPipelineLayout(dev, &pipeline_layout_info, vkmemcb, &pipeline_layout);
    ...
    try vkd.createGraphicsPipelines(dev, .null_handle, 1, &pipeline_info, vkmemcb, &graphics_pipeline);
